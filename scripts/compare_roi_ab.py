"""Compare same-commit full vs roi benchmark agent JSON against feat-039 hard gates.

Usage:
    uv run python scripts/compare_roi_ab.py \\
        debug/benchmark-reports/feat039_roi_ab/feat039_full/*.agent.json \\
        debug/benchmark-reports/feat039_roi_ab/feat039_roi/*.agent.json \\
