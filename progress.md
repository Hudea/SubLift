...
- **最后更新：** 2026-08-12
- **当前 Phase：** Phase 10 macOS Native Workbench UI 正在进行；10001、10102、10103、10104、10105、10206、10207、10208、10209 已完成。
- **进度真源：** `phases.json → detail_file`；本文件仅作会话导航。
- **下一优先：** 10310 实现 Subtitle Timeline 与播放导航（确定性时间几何、Previous/Next/Space 复用命令）。
- **当前计划：** `docs/plans/architecture/phase10-macos-workbench-ui.md`；主视觉与交互真源见 `docs/design_ui/`。

## 进行中

- 无正在实施的 Feature；等待启动 10310。

## 近期完成

- [x] 10209：Review、Subtitle Inspector 与 Export 已完成；Subtitle Inspector 真实字段（索引/时间/文本/低置信）、Review 可编辑、导出仅 review 且 SRT、V06 截图证据见 `docs/phases/phase10.json`。
...
> 10209 已完成；10310–10413 保持 `not-started`。
