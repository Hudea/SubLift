...
- **最后更新：** 2026-08-16
- **当前 Phase：** Phase 12 跨平台 Web UI 与 C++ 原生服务（apps/web-ui 分支）。12001（设计基线）、12101（C++ Web Server 与视频流）、12102（SSE 实时流与 Pipeline 调度）与 12201（Web 单视频工作台基础 UI）已完成，下一步推进 12202（Canvas ROI 选区交互与坐标映射）。Phase 8、Phase 7、Phase 10 已收口。
