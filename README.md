...
Benchmark 入口与指标说明见 [benchmark/README.md](benchmark/README.md)（设计见 [docs/design/benchmark.md](docs/design/benchmark.md)）。已验收的[质量与性能归因基线](benchmark/reports/README.md)随仓库版本化；本地重跑产物默认仍写入 `debug/`。
